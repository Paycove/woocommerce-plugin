...
function paycove_check_github_plugin_update($transient)
{
    ...
    if ($last_checked && $last_checked > time() - DAY_IN_SECONDS) {
        set_transient('paycove_last_checked', time(), DAY_IN_SECONDS);
        return $transient;
    }
...
add_filter('site_transient_update_plugins', 'paycove_check_github_plugin_update');
